...
internal static class Seeder
{
    ...
    public static async Task SeedAsync(AppDbContext context, UserManager<User> userManager)
    {
        ...
        var algorithms = new[]
        {
            ...
            new Algorithm { Case = cases[1], IsPublic = true, Moves = "F R U R' U' F' f R U R' U' f'", SetupMoves = "y'", CreatedAt = createdAt },
            new Algorithm { Case = cases[2], IsPublic = true, Moves = "f R U R' U' f' U' F R U R' U' F'", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[3], IsPublic = true, Moves = "f R U R' U' f' U F R U R' U' F'", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[4], IsPublic = true, Moves = "r' U2 R U R' U r", SetupMoves = "y'", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[7], IsPublic = true, Moves = "r' U' R U' R' U2 r", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[8], IsPublic = true, Moves = "R U R' U' R' F R2 U R' U' F'", SetupMoves = "y'", CreatedAt = createdAt },
            new Algorithm { Case = cases[9], IsPublic = true, Moves = "R U R' U R' F R F' R U2 R'", CreatedAt = createdAt },
            new Algorithm { Case = cases[10], IsPublic = true, Moves = "M R U R' U R U2 R' U M'", SetupMoves = "y'", CreatedAt = createdAt },
            new Algorithm { Case = cases[11], IsPublic = true, Moves = "M' R' U' R U' R' U2 R U' M", SetupMoves = "y'", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[14], IsPublic = true, Moves = "r' U' r R' U' R U r' U r", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[15], IsPublic = true, Moves = "r U r' R U R' U' r U' r'", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[16], IsPublic = true, Moves = "R U R' U R' F R F' U2 R' F R F'", CreatedAt = createdAt },
            new Algorithm { Case = cases[17], IsPublic = true, Moves = "R U2 R2 F R F' U2 M' U R U' r'", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[28], IsPublic = true, Moves = "R U R' U' R U' R' F' U' F R U R'", SetupMoves = "y2", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[35], IsPublic = true, Moves = "L' U' L U' L' U L U L F' L' F", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[43], IsPublic = true, Moves = "f R U R' U' f'", SetupMoves = "y2", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[48], IsPublic = true, Moves = "r U' r2 U r2 U r2 U' r", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[49], IsPublic = true, Moves = "r' U r2 U' r2 U' r2 U r'", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[50], IsPublic = true, Moves = "f R U R' U' R U R' U' f'", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[51], IsPublic = true, Moves = "R' F' U' F U' R U R' U R", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[52], IsPublic = true, Moves = "r' U' R U' R' U R U' R' U2 r", SetupMoves = "y2", CreatedAt = createdAt },
            new Algorithm { Case = cases[53], IsPublic = true, Moves = "r U R' U R U' R' U R U2 r'", CreatedAt = createdAt },
            new Algorithm { Case = cases[54], IsPublic = true, Moves = "R U2 R2 U' R U' R' U2 F R F'", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[60], IsPublic = true, Moves = "R' U' F' R U R' U' R' F R2 U' R' U' R U R' U R", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[66], IsPublic = true, Moves = "R' U L' U2 R U' R' U2 R L", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[70], IsPublic = true, Moves = "R U' R' U' R U R D R' U' R D' R' U2 R'", SetupMoves = "y", CreatedAt = createdAt },
            ...
            new Algorithm { Case = cases[73], IsPublic = true, Moves = "M2 U M U2 M' U M2", SetupMoves = "y2", CreatedAt = createdAt },
